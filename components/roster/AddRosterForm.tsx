...
export function AddRosterForm({
  ...
  const [birthDate, setBirthDate] = useState(initial?.pet?.birthDate ?? "");
        ...
        {kind === "pet" && (
          <>
            <div className="flex flex-col gap-1.5">
              <span className={label}>Species and breed</span>
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <div className={`${field} flex items-center pointer-events-none`}>
                      {birthDate ? (
                        formatDate(new Date(`${birthDate}T00:00:00`))
                      ) : (
            ...
            <button
              ...
              className="text-xs font-semibold text-(--color-primary-text) text-left"
            >
